...
<div class="flex items-center justify-center min-h-screen max-w-6xl mx-auto bg-[#FAF6F0]">
    <div class="max-w-md w-full bg-white p-8 rounded-xl shadow-md">
        <h1 class="text-3xl font-display font-semibold text-stone-900 mb-4 text-center">Sign In To Your Account</h1>
        <form action="/ordering-system/auth/signin.php" method="POST" class="space-y-4">
            <div>
        ...
        <p class="mt-4 text-center text-sm text-stone-600">
            ...
            <a href="/ordering-system/auth/signup.php" class="text-amber-600 hover:text-amber-500">Sign Up</a>
        </p>
    </div>
</div>
